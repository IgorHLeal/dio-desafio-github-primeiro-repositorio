...
public class Bazinga {
        ...
        for (int i = 1; i <= qtdTeste; i++) //insira a variavel correta
        {
            ...
            if
                ((jogadaSheldon == "TESOURA" && jogadaRaj == "PAPEL") || ( jogadaSheldon == "PAPEL" && jogadaRaj == "PEDRA") //complete a soluусo
                ...
                Console.WriteLine("Caso #{0}: Bazinga!", i);                
    			          ...
    			          ((jogadaRaj == "TESOURA" && jogadaSheldon == "PAPEL") || ( jogadaRaj == "PAPEL" && jogadaSheldon == "PEDRA") //complete a soluусo
